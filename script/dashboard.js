...
const mensajes = [
    "🔥 Eres como un crítico de Jhin: siempre llegas en el momento exacto y me deja sin aliento.",
    "💖 Tú y yo somos como una buena composición en LoL: juntos hacemos el combo perfecto.",
    "✨ No necesito wards, porque tu amor me ilumina el mapa de mi vida.",
    "🥰 Mi amor por ti es como la pasiva de Anivia: aunque caiga, siempre renace más fuerte.",
    "❤️ Eres mi ADC y yo tu support, juntos hacemos la botlane perfecta.",
    "🔮 Si fueras una habilidad, serías la Q de Morgana, porque cuando me atrapas, no quiero escapar.",
    "🌙 Nuestro amor es como la pasiva de Senna, con el tiempo solo se vuelve más fuerte.",
];
